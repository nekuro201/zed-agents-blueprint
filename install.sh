...
# Garante a existencia da pasta de skills e copia/sobrescreve as definicoes dos agentes
mkdir -p "$TARGET_DIR/skills"
cp -rf "$BLUEPRINT_DIR/skills/"* "$TARGET_DIR/skills/"
echo "Skills locais atualizadas em skills/"
...
echo "Setup concluido. Ajuste o AGENTS.md e configure as skills locais no editor Zed."
